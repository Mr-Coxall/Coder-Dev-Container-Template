...
data "coder_parameter" "custom_repo_url" {
  default      = "https://github.com/Mr-Coxall/Debian-Dev-Container"
  description  = "Replace the URL below with your Development Containers Repository URL."
  display_name = "Enter a custom Development Containers repository URL."
...
#  default      = "ghcr.io/devcontainers/templates/debian:3.0.2"
...
locals {
  ...
  repo_url                   = data.coder_parameter.custom_repo_url.value
  ...
  envbuilder_env = {
    ...
    "ENVBUILDER_FALLBACK_IMAGE" : "ghcr.io/devcontainers/templates/debian:3.0.2",
...
# removed because using VS Code Web version
...
module "vscode-web" {
  ...
  # so it does not ask you f you trust the conainer code, since hopefully it is your code!
  settings = {
    "security.workspace.trust.enabled" = "false"
  }
  accept_license = true
  auto_install_extensions = true
  # concatonate the workspace directoy with the name of the repo, which is what 
  #   GitHub Codespaces does
  folder = join("/", ["", "workspaces", basename(data.coder_parameter.custom_repo_url.value)])
}
